    ...
    const seoCopy =
        lang === 'ar'
            ? {
                ...
                description:
                    'أمواج الرائدة وكالة تسويق رقمي سعودية تقدم تصميم الهوية البصرية، إدارة وسائل التواصل الاجتماعي، إنشاء المحتوى، بناء وتطوير المواقع والمتاجر، إدارة الحملات، وتحسين محركات البحث لنتائج نمو قابلة للقياس.',
                keywords: ['أمواج الرائدة', 'امواج الرائدة', 'تسويق رقمي', 'بناء مواقع', 'وكالة تسويق في السعودية', ...spreadsheetKeywords].join(', '),
