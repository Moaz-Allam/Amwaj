...
const PageContent = () => {
    ...
    const seoCopy =
        lang === 'ar'
            ? {
                title: 'أمواج الرائدة | وكالة تسويق رقمي وبناء مواقع في السعودية',
                description:
                    'أمواج الرائدة وكالة تسويق رقمي سعودية تقدم تصميم الهوية البصرية، إدارة وسائل التواصل الاجتماعي، إنشاء المحتوى، تطوير وبناء المواقع والمتاجر الإلكترونية، إدارة الحملات، وتحسين محركات البحث لنتائج نمو قابلة للقياس.',
                keywords: ['أمواج الرائدة', 'امواج الرائدة', 'امواج الرايدة', 'امواج الرايده', 'تسويق رقمي', 'وكالة تسويق رقمي', 'بناء مواقع', 'تصميم مواقع', 'وكالة تسويق في السعودية', ...spreadsheetKeywords].join(', '),
                imageAlt: 'شعار أمواج الرائدة - وكالة تسويق رقمي في الرياض',
            }
            : {
            ...
            itemListElement: serviceSeoClusters.map((cluster, index) => ({
                ...
                item: {
                    ...
                    provider: {
                        ...
                        name: 'Amwaj Al-Raeda',
                        url: 'https://www.amwajalraeda.com',
                    },
                },
            })),
        }),
