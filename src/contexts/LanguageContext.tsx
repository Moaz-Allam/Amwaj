...
const translations: Translations = {
  ...
  'service.4.title': { en: 'Search Engine Optimization (SEO)', ar: 'تحسين محركات البحث' },
  ...
  'faq.1.q': { en: 'Do you provide SEO as part of your services?', ar: 'هل تقدمون خدمة تحسين محركات البحث ضمن خدماتكم؟' },
  'faq.1.a': { en: 'Yes. We implement structured SEO strategies including technical optimization, keyword research, on-page optimization, content optimization, and performance tracking.', ar: 'نعم، نضع استراتيجية تحسين محركات البحث متكاملة تشمل التحسين التقني، تحليل الكلمات المفتاحية، تحسين الصفحات والمحتوى، ومتابعة الأداء.' },
  ...
  'footer.phone': { en: 'Phone', ar: 'رقم الهاتف' },
